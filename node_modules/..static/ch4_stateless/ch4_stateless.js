...
var orders = [{
    id: 1, status: 'Pro cessing', user: 'Chris88', created: new Date('2017-10-09'),
    total: 114.98, completedDate: undefined, title: 'Roll Tide Roll'
}, {
    id: 2, status: 'completed', user: 'bvail1', created: new Date('2017-09-21'),
