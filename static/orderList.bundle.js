...
var OrderAdd   = __webpack_require__(14);
var React       = __webpack_require__(1);
var create      = React.createElement;


var OrderFilter = createClass({
    propTypes:{
...
var OrderList = createClass({
    ...
    LoadData: function(){
      ...
      fetch("http://localhost:3000/api/orders", myInit).then(function(response){
        ...
        alert('error in fetching data from server: ' + error.message, err.message);
      });
    },
    ...
    CreateOrder: function(newOrder){
      fetch("api/orders", {
        ...
        if(response.ok){
          resonse.json().then(function(updatedOrder){
...
var m=__webpack_require__(2),n=__webpack_require__(3),p=__webpack_require__(4),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
